...
public final class DefaultDictionary {
	...
	public static BurmaldynDictionary create() {
		...
		for (String stem : new String[]{
				...
				"спрут", "мазут", "статут", "институт", "атрибут", "дебют", "уют",
				"лоскут", "обмен", "токен", "экран", "банан", "стакан", "океан",
				"карман", "вулкан", "капитан", "барабан",
				// существительные, которые прячутся за возвратным «-ся»: лосося, карася
				"лосос", "карас"}) {
